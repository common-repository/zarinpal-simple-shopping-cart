=== WordPress Simple Zarinpal Shopping Cart ===
Contributors: Mostafa Amiri

Tags: WordPress shopping cart, Zarinpal shopping cart, online shop, shopping cart, wordperss ecommerce, sell digital products, Shetab, شتاب, دروازه آنلاين, پرداخت آنلاين
Requires at least: 2.6
Tested up to: 3.0
Stable tag:1.0.2

Very easy to use Simple WordPress Zarinpal Shopping Cart Plugin. Great for selling products online in one click from your WordPress site.

== Description ==

WordPress Simple Zarinpal Shopping Cart allows you to add an 'Add to Cart' button on any posts or pages. It also allows you to add/display the shopping cart on any post or page or sidebar easily. The shopping cart shows the user what they currently have in the cart and allows them to remove the items. It can be easily integrated with the NextGen Photo Gallery plugin too.
...
1. Unzip and Upload the folder 'wordpress-Zarinpal-shopping-cart' to the '/wp-content/plugins/' directory
...
1. Can this plugin be used to accept Zarinpal payment for a service or a product? Yes
...
6. Does this plugin use a return URL to redirect customers to a specified page after Zarinpal has processed the payment? Yes.


== Screenshots ==
Visit the plugin site at https://www.zarinpal.com/pages/labs/index/ for screenshots.

== Changelog ==
Changelog can be found at the following URL
http://wordpress.org/extend/plugins/zarinpal-simple-shopping-cart/
